    ...
    return (
        <header id="header" className="header dark-background d-flex flex-column">
            ...
            <a href="index.html" className="logo d-flex align-items-center justify-content-center">
                {/* <img src="assets/img/plogo.jpg" alt=""> */}
                <h1 className="sitename">Arghya Biswas</h1>
            </a>

            <div className="social-links text-center">
                <a href="https://github.com/Arghya044" className="twitter" target='blank'><i className="bi bi-github "  ></i></a>
                <a href="https://www.facebook.com/arghya477" className="facebook" target='blank'><i className="bi bi-facebook" ></i></a>
                <a href="https://www.instagram.com/arghya477/" className="instagram"target='blank'><i className="bi bi-instagram"></i></a>
                {/* <a href="#" className="google-plus"><i className="bi bi-skype"></i></a> */}
                <a href="www.linkedin.com/in/-biswas-arghya" className="linkedin"target='blank' ><i className="bi bi-linkedin"></i></a>
            </div>
